...
function AIGuidance() {
   ...
   *
   * Later these values will come from the AI analysis.
   * For now they are calculated from the student's
   * actual saved skills.
   */
        ...
        <section className="ai-analysis-card">
          ...
          <div className="ai-analysis-heading">
            ...
            <div>
              ...
              <p>
                Your profile data is now connected to the
                CareerForge Career Navigator.
              </p>
